...
#    for i in range(num_epochs) :
	...
	for i in range(num_epochs) :
		...
		#print 'class is'
		#print myData[k][-1]
		    if myData[k][-1] == classes[0] :
		    #print 'Rock'
		        y = 0
		    if myData[k][-1] == classes[1] :
		    #print 'Mine'
		        y = 1
		#change input
		    instance = myData[k]
	...
	for k in range(len(testSet)) :
	    ...
	    if predictedClass == 0:
	        print leave, classes[0] , actualClass, o
	    else:
		print leave, classes[1] , actualClass, o
	    if predictedClass == 0 and actualClass == classes[0]:
		accurate = accurate + 1
	    if predictedClass == 1 and actualClass == classes[1]:
                accurate = accurate + 1
